...
- **Domination**: dares only (no truths), with two selectors:
  - **Setting**: In person / Remote (remote dares are provable via photo or video sent to the group)
  - **Category**: Non-sexy / Sexy, each with 3 difficulty levels
...
```json
{
  "fr": {
    ...
    "dom_sexy2":    { "dare": [...] },
    "dom_sexy3":    { "dare": [...] },
    "dom_remote_nonsexy1": { "dare": [...] },
    "dom_remote_nonsexy2": { "dare": [...] },
    "dom_remote_nonsexy3": { "dare": [...] },
    "dom_remote_sexy1":    { "dare": [...] },
    "dom_remote_sexy2":    { "dare": [...] },
    "dom_remote_sexy3":    { "dare": [...] }
  },
  "en": {
    "friends": { "truth": [...], "dare": [...] },
    "hot1":    { "truth": [...], "dare": [...] },
...
- `dom_nonsexy1/2/3` → "Domination" mode, In person setting, Non-sexy category, levels 1 to 3
- `dom_sexy1/2/3` → "Domination" mode, In person setting, Sexy category, levels 1 to 3
- `dom_remote_nonsexy1/2/3` → "Domination" mode, Remote setting, Non-sexy category, levels 1 to 3 (dares provable via photo/video)
- `dom_remote_sexy1/2/3` → "Domination" mode, Remote setting, Sexy category, levels 1 to 3 (dares provable via photo/video)

All `dom_*` pools only have a `dare` array (no `truth`) since Domination mode is dare-only: the Truth/Dare choice screen is hidden for this mode, and the player always draws a dare.
...
1. **Home screen** (`view-home`): the user picks a language (`setLang`), a mode (`setMode`) and:
   ...
   - in Domination mode, a setting (`setDominationLocation`: In person / Remote), a category (`setDominationCategory`: Non-sexy / Sexy) and a difficulty level via the slider (`updateDominationDifficulty`)
